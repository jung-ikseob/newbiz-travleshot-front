    ...
    <div className="min-h-screen bg-service-bg font-pretendard">
      <div className="max-w-md mx-auto bg-service-bg relative pb-20">
          ...
          <div className="flex items-center gap-1.5 text-sm">
            <div className="flex items-center gap-1">
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M22.7992 16.8022V7.1974C22.7992 5.8732 21.7258 4.7998 20.4022 4.7998H3.59622C2.27202 4.7998 1.19922 5.8732 1.19922 7.1974V16.8028C1.19922 18.127 2.27262 19.2004 3.59622 19.2004H20.4016C21.7258 19.2004 22.7986 18.127 22.7986 16.8028L22.7992 16.8022ZM15.064 13.9966C13.936 15.6508 11.6482 16.0978 9.95562 14.995C8.26302 13.8922 7.80582 11.6572 8.93442 10.003C8.92062 10.0222 8.90802 10.042 8.89542 10.0612C8.90802 10.0414 8.92122 10.0222 8.93442 10.003C10.0624 8.3488 12.3502 7.9018 14.0428 9.004C15.7354 10.1068 16.1926 12.3418 15.064 13.9966Z"
                  fill="#E3E7EA"
                />
                <path
                  d="M16.0868 7.17383L17.0234 8.54663L16.5128 8.87963L15.5762 7.50623L16.0868 7.17383Z"
                  fill="#191F28"
                />
                <path
                  d="M17.1922 8.79688L18.1288 10.1697L17.6182 10.5027L16.6816 9.12987L17.1922 8.79688Z"
                  fill="#191F28"
                />
                ...
                <path
                  d="M18.7254 7.79785L19.6614 9.17065L19.1508 9.50365L18.2148 8.13085L18.7254 7.79785Z"
                  fill="#191F28"
                />
                <path
                  d="M6.38169 13.498L8.42469 16.4938L7.91409 16.8262L5.87109 13.831L6.38169 13.498Z"
                  fill="#191F28"
                />
                <path
                  d="M5.61412 13.9971L6.55012 15.3705L6.03952 15.7029L5.10352 14.3301L5.61412 13.9971Z"
                  fill="#191F28"
                />
                <path
                  d="M6.72154 15.6191L7.65814 16.9919L7.14754 17.3249L6.21094 15.9521L6.72154 15.6191Z"
                  fill="#191F28"
                />
                <path
                  d="M4.84849 14.4961L6.89149 17.4919L6.38089 17.8249L4.33789 14.8291L4.84849 14.4961Z"
                  fill="#191F28"
                />
                <path
                  d="M5.87109 10.169L7.91409 7.17383L8.42469 7.50683L6.38169 10.502L5.87109 10.169Z"
                  fill="#191F28"
                />
                <path d="M5.10352 9.6706L7.14652 6.6748L7.65712 7.0078L5.61412 10.003L5.10352 9.6706Z" fill="#191F28" />
                <path
                  d="M4.33789 9.17098L6.38089 6.17578L6.89149 6.50878L4.84849 9.50398L4.33789 9.17098Z"
                  fill="#191F28"
                />
                <path
                  d="M15.5762 16.4929L16.5128 15.1201L17.0234 15.4525L16.0868 16.8253L15.5762 16.4929Z"
                  fill="#191F28"
                />
                <path
                  d="M16.6816 14.8714L17.6182 13.498L18.1288 13.831L17.1922 15.2038L16.6816 14.8714Z"
                  fill="#191F28"
                />
                <path
                  d="M16.3418 16.9919L17.2784 15.6191L17.789 15.9521L16.8524 17.3249L16.3418 16.9919Z"
                  fill="#191F28"
                />
                <path
                  d="M17.4492 15.3705L18.3858 13.9971L18.8964 14.3301L17.9604 15.7029L17.4492 15.3705Z"
                  fill="#191F28"
                />
                <path
                  d="M17.1094 17.4919L18.046 16.1191L18.5566 16.4515L17.62 17.8249L17.1094 17.4919Z"
                  fill="#191F28"
                />
                <path
                  d="M18.2148 15.8689L19.1508 14.4961L19.6614 14.8291L18.7254 16.2019L18.2148 15.8689Z"
                  fill="#191F28"
                />
                <path
                  d="M14.0431 9.00435C12.3505 7.90155 10.0627 8.34855 8.93466 10.0033C8.37006 10.8301 8.59926 11.9479 9.44526 12.4993C10.2919 13.0507 11.4349 12.8269 11.9995 12.0001C12.5635 11.1733 13.7071 10.9495 14.5531 11.5009C15.3997 12.0523 15.6283 13.1695 15.0637 13.9969C16.1923 12.3421 15.7357 10.1077 14.0431 9.00435Z"
                  fill="#C60038"
                />
                <path
                  d="M14.554 11.5005C13.7074 10.9491 12.5644 11.1723 12.0004 11.9997C11.4358 12.8265 10.2922 13.0503 9.44622 12.4989C8.59962 11.9475 8.37102 10.8297 8.93562 10.0029C7.80702 11.6571 8.26422 13.8921 9.95682 14.9949C11.6494 16.0977 13.9372 15.6507 15.0652 13.9965C15.6298 13.1691 15.4006 12.0519 14.554 11.5005Z"
                  fill="#243679"
                />
              </svg>
            </div>
            ...
            <div className="flex items-center gap-1">
              ...
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M22.7992 16.8022V7.1974C22.7992 5.8732 21.7258 4.7998 20.4022 4.7998H3.59622C2.27202 4.7998 1.19922 5.8732 1.19922 7.1974V16.8028C1.19922 18.127 2.27262 19.2004 3.59622 19.2004H20.4016C21.7258 19.2004 22.7986 18.127 22.7986 16.8028L22.7992 16.8022Z"
                  fill="#E3E7EA"
                />
                <path
                  d="M11.9993 7.67969C9.59874 7.67969 7.65234 9.61409 7.65234 11.9997C7.65234 14.3853 9.59814 16.3197 11.9993 16.3197C14.4005 16.3197 16.3457 14.3853 16.3457 11.9997C16.3457 9.61409 14.3999 7.67969 11.9993 7.67969Z"
                  fill="#BD001A"
                />
              </svg>
            </div>
        ...
        {isModalOpen && (
          ...
          >
            <div className="w-full max-w-md flex flex-col" onClick={(e) => e.stopPropagation()}>
              <div className="w-full relative h-[307px]">
                ...
                <div className="absolute left-5 top-[55px] w-[335px] h-[232px] flex flex-col items-end gap-[13px]">
                  <button onClick={() => setIsModalOpen(false)} className="w-6 h-6 flex-shrink-0">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M20.0293 20.2295L4.0293 4.22949"
                        stroke="#6B7583"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                      />
                      <path
                        d="M4.0293 20.2227L20.0293 4.22266"
                        stroke="#6B7583"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                      />
...
const NavItem = ({
  ...
  <button onClick={onClick} className="flex flex-col items-center gap-0.5 hover:opacity-75 transition-opacity">
    ...
    {icon === "card" && (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect
          ...
          height="16"
          rx="2"
          stroke={active ? "#191F28" : "rgba(25, 31, 40, 0.30)"}
          strokeWidth="1.5"
          fill="none"
        />
    ...
    <span
      className={`text-xs text-center leading-[14.4px] ${active ? "text-[#191F28] font-medium" : "text-[#191F28]/60"}`}
    >
      {label}
    </span>
  </button>
