...
const Ocr: FC = () => {
  ...
  <div className="flex flex-col items-center justify-between h-full px-5 py-8 relative z-20">
          <div className="flex-1 flex flex-col items-center justify-center gap-8 max-w-md w-full">
            ...
            <div className="relative w-full max-w-[335px] aspect-[335/240]">
              {/*
                Central cutout: use a large spread box-shadow to create an overlay around
                the transparent center. The element itself is transparent so the video
                underneath shows through. Text/buttons are placed with higher z-index
                so they remain visible above the overlay.
              */}
              <div
                className="absolute inset-0 rounded-[20px] border-2 border-white bg-transparent"
                style={{ boxShadow: '0 0 0 9999px rgba(25,31,40,0.5)' }}
              />
              <div className="absolute inset-0 rounded-[10px] border-4 border-white pointer-events-none" />
            </div>
